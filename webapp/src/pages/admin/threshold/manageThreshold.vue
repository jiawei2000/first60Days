        ...
        <VCardText>
            ...
            <VWindow v-model="activeTab">
                ...
                <VWindowItem value="daily">
                    <VDataTable :headers="headers" :items="dailyRows" :items-per-page="10" class="elevation-1">
                        ...
                        <template #item.action="{ item }">
                            <VBtn color="primary" variant="tonal" size="small" @click="goEdit('daily', item.key)">
                                Edit
                            </VBtn>
                        </template>
                    </VDataTable>
                ...
                <VWindowItem value="weekly">
                    <VDataTable :headers="headers" :items="weeklyRows" :items-per-page="10" class="elevation-1">
                        <template #item.key="{ item }">
                            <span class="font-weight-medium">{{ formatKey(item.key) }}</span>
                        </template>
                        ...
                        <template #item.action="{ item }">
                            <VBtn color="primary" variant="tonal" size="small" @click="goEdit('weekly', item.key)">
                                Edit
                            </VBtn>
                        </template>
                    </VDataTable>
