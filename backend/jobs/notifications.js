...
// Schedule job to run at 0000 every day
// cron.schedule('*/10 * * * * *', async () => {
//   console.log('[Scheduler] Test notification every 10 seconds');
//   await NotificationService.sendDailyBabyJournalReminder();
// });

cron.schedule('0 0 * * *', async () => {
  console.log('[Scheduler] Sending baby journal reminder at 12:00 AM');
  await NotificationService.sendDailyBabyJournalReminder();
}, {
